...
module Demo3.PartialLocking2 where
...
distrLogElem i = alt2_2 & _2 & _multi & distrLogElem (i-1)
...
type instance Node LogDB = Multi
type instance Node LogList = Multi
type instance Node [Log] = Multi
...
amortizeMeasure repeatNum
  = do resf <- openFile "../partial-locking-measure-amortize2.csv" WriteMode
...
categoryMeasure repeatNum 
  = do resf <- openFile "../partial-locking-measure-cats2.csv" WriteMode
